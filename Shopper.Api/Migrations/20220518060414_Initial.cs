    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ShoppingListItemCategories",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingListItemCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingListItems_ShoppingListItemCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "ShoppingListItemCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
